...
const dictionaryBg = {
  meta: {
    ...
    defaultTitle: "Озеленяване София | BG.GREEN_YARD – Озеленяване и поддръжка",
    defaultDesc:
      "Професионално озеленяване и поддръжка на градини в София. Косене, тревни площи, поливни системи и зелени площи.",
  },
  nav: {
    home: "Начало",
    about: "За нас",
  ...
  home: {
    ...
    heroTitle: "Озеленяване и поддръжка в София",
    heroLead:
      "BG.GREEN_YARD предлага професионално озеленяване, изграждане и поддръжка на градини и зелени площи в София и околностите.",

...
const dictionaryBg = {
  ...
  about: {
    ...
    missionBody:
      "Мисията ни е да създаваме подредени, здрави и красиви зелени пространства за живот и работа в София и окрайност. Градим дългосрочни партньорства, основани на надеждност и висока степен на изпълнение.",
    visionBody:
      "Вярваме, че всеки добре поддържан двор носи повече спокойствие и стойност на имота. Подхождаме индивидуално към всеки проект, като следим качеството във всяко време на годината.",
    ...
    why1Body:
      "Работим в столицата и региона — бърза реакция, познаване на терена и сезонните нужди на градини и общи площи.",
  ...
  services: {
    ...
    intro:
      "Комбинираме услугите според обекта — от еднократни проекти до абонаментна грижа. Всички дейности са с ориентация към трайност, безопасност и удобство.",
    ...
    snow: {
      ...
      body: "Механизирано и ръчно почистване на алеи, паркоместа и достъпи при зимни условия. Поддържаме сигурност и проходимост на жилищни и бизнес имоти.",
    },
    green: {
      title: "Професионално озеленяване и поддръжка",
      body: "Проектиране и изпълнение на озеленяване, поддръжка на градини, нивелиране и поддръжка на тревни площи — вкл. подстригване, аерация, торене и сезонни работи.",
    },
    irrigation: {

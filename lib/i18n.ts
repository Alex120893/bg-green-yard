...
const dictionaryBg = {
  ...
  home: {
    heroEyebrow: "София и регион",
    heroTitle: "Подреден двор. Спокойствие. Трайни решения.",
    heroLead:
      "Професионално озеленяване, абонаментна поддръжка на градини и поливни системи — с фокус върху качество, коректност и дългосрочни партньорства.",
    ...
    brandsLead:
      "Комбинираме модерни технологии и траен опит, за да поддържаме градини и тревни площи представителни през цялата година.",
  },
  about: {
    title: "За компанията",
    ...
    missionBody:
      "Мисията ни е да създаваме подредени, здрави и красиви зелени пространства за живот и работа в София и околните райони. Стремим се към дългосрочни партньорства, изградени на коректност и висок стандарт на изпълнение.",
    visionBody:
    ...
    why1Body:
      "Работим в столицата и региона — бърза реакция, познаване на терена и сезонните нужди на градини и общи части.",
  ...
  services: {
    ...
    intro:
      "Комбинираме услугите според обекта — от еднократни проекти до абонаментна грижа. Всички дейности са с ориентация към устойчивост, сигурност и удобство за клиента.",
    ...
    snow: {
      ...
      body: "Механизирано и ръчно почистване на алеи, паркоместа и достъпи при зимни условия. Поддържаме сигурност и проходимост за жилищни и бизнес обекти.",
    },
    green: {
      title: "Професионално озеленяване и поддръжка",
      body: "Проектиране и изпълнение на озеленяване, поддръжка на градини, нивелиране и поддръжка на тревни площи — косене, аерация, торене и сезонна грижа.",
    },
    irrigation: {
      title: "Поливни системи",
      body: "Проектиране, монтаж и поддръжка на капково и разпръскващо подземно/надземно поливане, автоматика и зониране за икономия на вода и равномерен растеж.",
    },
  },
  gallery: {
    title: "Галерия",

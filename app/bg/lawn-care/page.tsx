...
export default function LawnCare() {
  const lawnCareGuides = [
    ...
    },
    {
      ...
      icon: "🚫",
      tips: [
        "Редовно кошене вытесня сорняци",
        "Здравият газон сам се защитава от сорняци",
    ...
    },
    {
      ...
      icon: "🌍",
      tips: [
        "Пролет: аерирайте, торете, почнете редовно косене",
        "Лято: интензивен полив, по-редко косене",
        "Есен: последно торене, подготовка за зима",
        "Зима: минимален уход, избягвайте вървене по замръзнал газон",
  ...
  const seasonalSchedule = [
    {
      ...
      tasks: [
        "Аерирайте газона",
        "Торете с азотни удобрения",
        "Почнете редовно косене (всеки 7-10 дни)",
        "Боритесь със сорняци",
        "Проверете дренажа"
      ]
    },
    {
      ...
      tasks: [
        ...
        "Торете с калийно-фосфорни удобрения",
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="mr-3">✓</span>
                  <span>Използвайте органични удобрения</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-3">✓</span>

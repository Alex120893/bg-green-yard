...
export default function PlantAndLawnCare() {
  ...
  const plants = {
    ...
    flowers: [
      { id: 13, name: "Роза (Rosa spp.)", description: "Царица на цветята, символ на красотата", care: ["Поливане: Редовно и обилно", "Светлина: Минимум 6 часа слънце", "Подхранване: Редовно през растежния период", "Подрязване: През пролетта", "Почва: Добре дренирана, плодородна"] },
      { id: 14, name: "Тюлипан (Tulipa spp.)", description: "Ранна пролетна цветя с богат избор на цветове", care: ["Поливане: Умерено", "Светлина: Пълно слънце", "Почва: Добре дренирана", "Засаждане: През есента", "Цъфтене: Ранна пролет"] },
      { id: 15, name: "Нарцис (Narcissus spp.)", description: "Ярка пролетна цветя със специфичен аромат", care: ["Поливане: Умерено през растежния период", "Светлина: Пълно слънце до полусянка", "Почва: Добре дренирана", "Засаждане: През есента", "Цъфтене: Февруари-март"] },
      { id: 16, name: "Лилия (Lilium spp.)", description: "Елегантна цветя с силен аромат", care: ["Поливане: Редовно, избягвайте преливане", "Светлина: Пълно слънце", "Подхранване: Редовно", "Почва: Добре дренирана", "Висина: До 2 метра"] },
      { id: 17, name: "Герань (Pelargonium spp.)", description: "Популярна балконна цветя с красиви листа", care: ["Поливане: Редовно, но не прекомерно", "Светлина: Пълно слънце", "Почва: Лека, добре дренирана", "Температура: Топло местоположение", "Цъфтене: Цяло лято"] },
      { id: 18, name: "Хортензия (Hydrangea spp.)", description: "Блестящо цъфтяща с големи соцветия", care: ["Поливане: Обилно редовно", "Светлина: Полусянка е идеална", "Подхранване: Редовно", "Подрязване: След цъфтежа", "Почва: Кисла, добре дренирана"] }
    ],
    vegetables: [
      { id: 19, name: "Домат (Solanum lycopersicum)", description: "Популярна овощ за лятното градинство", care: ["Поливане: Редовно и обилно", "Светлина: Пълно слънце", "Подхранване: Редовно", "Поддържане: Нужни са опори", "Събиране: През лято и есен"] },
      { id: 20, name: "Краставица (Cucumis sativus)", description: "Зеленчук, нуждаещ се от топлина и влага", care: ["Поливане: Обилно и редовно", "Светлина: Пълно слънце", "Почва: Богата, добре дренирана", "Температура: Топла", "Събиране: През лято"] },
      { id: 21, name: "Пипер (Capsicum annuum)", description: "Термофилна овощ с богат вкус", care: ["Поливане: Редовно и умерено", "Светлина: Пълно слънце", "Подхранване: Редовно", "Температура: Топла", "Събиране: През лято и есен"] },
      { id: 22, name: "Лук (Allium cepa)", description: "Незаменим в кухнята и лесен за отглеждане", care: ["Поливане: Умерено", "Светлина: Пълно слънце", "Почва: Богата", "Засаждане: Пролет или есен", "Събиране: След 3-6 месеца"] },
      { id: 23, name: "Чесън (Allium sativum)", description: "Вкусна овощ с здравословни свойства", care: ["Поливане: Умерено в основата", "Светлина: Пълно слънце", "Почва: Богата, добре дренирана", "Засаждане: През есента", "Събиране: През лято"] },
      { id: 24, name: "Моркови (Daucus carota)", description: "Сладко-оранжев коренен зеленчук", care: ["Поливане: Редовно и умерено", "Светлина: Пълно слънце до полусянка", "Почва: Рохава, добре дренирана", "Оредяване: През май", "Събиране: През есен"] }
    ]
  };

  const generalCare = [
    { title: "Поливане", tips: ["Поливайте рано сутрин или късно вечер, за да избегнете изпаряване", "През лятото поливайте 2-3 пъти седмично", "Избягвайте поливане по листата", "Използвайте лукова вода"] },
    { title: "Торене и подхранване", tips: ["Подхранвайте растенията през вегетационния период", "Използвайте комплексни торове", "Следвайте инструкциите на торовете", "Подхранвайте всеки 2-4 седмици"] },
    { title: "Подрязване и формиране", tips: ["Редовното подрязване насърчава гъстия растеж", "Подрязвайте през вегетационния период", "Отстранявайте болни или мъртви клони", "Оформяйте желаната форма"] },
    { title: "Почва и мулчиране", tips: ["Добре дренирана почва е критична", "Мулчирайте с органични материали", "Поддържайте влажност на почвата", "Проверявайте pH на почвата"] },
    { title: "Защита от болести и вредители", tips: ["Редовно проверявайте растенията", "Премахвайте засегнатите листа", "Използвайте натурални пестициди", "Поддържайте чистота около растенията"] }
  ];

  // LAWN DATA
  const lawnCareGuides = [
    { title: "Поливане на тревата", icon: "💧", tips: ["Поливайте рано сутрин или късно вечер, за да избегнете изпаряване", "През лятото поливайте 2-3 пъти седмично", "Ориентировайте се на 10-15 литра на квадратен метър", "Използвайте капково напояване за по-ефективен полив"] },
    { title: "Косене", icon: "✂️", tips: ["Косете всеки 7-10 дни през вегетационния период", "Поддържайте височина на тревата 4-5 см", "Никога не отстранявайте повече от 1/3 от височината", "Използвайте остър нож на коса за чисти срезки"] },
    { title: "Торене и подхранване", icon: "🌱", tips: ["Пролет: азотни торове за бърз растеж", "Лято: калийно-фосфорни торове за здравост", "Есен: специални есенни торове", "Торете всеки 4-6 седмици"] },
    { title: "Борба с плевели", icon: "🚫", tips: ["Редовното косене ограничава плевелите", "Здравата тревна площ се защитава по-добре от плевели", "Ръчна прополка за малки участъци", "Селективни гербициди при необходимост"] },
    { title: "Аерация и дренаж", icon: "🌬️", tips: ["Аерирайте газона 1-2 пъти годишно", "Пролет и есен са идеални периоди", "Използвайте специален аератор или градинска вила", "Подобрява дренажа и растежа"] },
    { title: "Вертикутиране", icon: "⚙️", tips: ["Вертикутирайте през пролетта или есента", "Отстранява мъртва трава и вретеница", "Проветрява почвата", "Подобрява растежа"] },
    { title: "Защита от болести", icon: "🛡️", tips: ["Здравата трава е защитена от болести", "Избягвайте прекомерно овлажняване", "Поддържайте добра аерация", "Редовно инспектирайте газона"] },
    { title: "Сезонна грижа", icon: "🌍", tips: ["Пролет: аерирайте, торете и започнете редовно косене", "Лято: интензивно поливане, редовно косене", "Есен: подготовка за зимата, последно торене", "Зима: минимална грижа, съхранение на инструменти"] }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="bg-gradient-to-r from-green-600 to-green-700 rounded-lg shadow-lg p-8 text-white text-center">
          ...
          <p className="text-green-50 mb-6">Свържете се с нас за персонални съветы и консултации за вашия град или тревата</p>
          <Link
            href="/bg/contact"

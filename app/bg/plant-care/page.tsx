...
export default function PlantAndLawnCare() {
  ...
  const plants = {
    ...
    flowers: [
      ...
      { id: 14, name: "Тюлипан (Tulipa spp.)", description: "Ранна пролетна цветя с богат избор на цветове", care: ["Поливане: Умерено", "Светлина: Пълно слънце", "Подхранване: При засаждане добавете торове", "Почва: Добре дренирана", "Гнезда се през октомври-ноември"] },
      { id: 15, name: "Нарцис (Narcissus spp.)", description: "Ярка пролетна цветя със специфичен аромат", care: ["Поливане: Умерено при растеж", "Светлина: Пълно слънце или полусянка", "Подхранване: При засаждане добавете органични торове", "Почва: Добре дренирана", "Гнезда се през септември-октомври"] },
      { id: 16, name: "Лилия (Lilium spp.)", description: "Елегантна цветя с силен аромат", care: ["Поливане: Редовно, избягвайте преливане", "Светлина: Минимум 6 часа слънце", "Подхранване: Торове при растеж", "Подрязване: Отстранете отцъфтелите цветя", "Гнезда се през пролетта"] },
      { id: 17, name: "Герань (Pelargonium spp.)", description: "Популярна балконна цветя с красиви листа", care: ["Поливане: Редовно, но избягвайте преливане", "Светлина: Пълно слънце", "Подхранване: Редовно през растежния период", "Подрязване: Формирайте през пролетта", "Почва: Добре дренирана, суха"] },
      { id: 18, name: "Хортензия (Hydrangea spp.)", description: "Блестящо цъфтяща с големи соцветия", care: ["Поливане: Обилно редовно", "Светлина: Полусянка е идеална", "Подхранване: Редовно през растежния период", "Подрязване: След цъфтежа", "Почва: Киселинна почва за синьо, неутрална за розово"] },
    ],
    vegetables: [
      { id: 19, name: "Домат (Solanum lycopersicum)", description: "Популярна овощ за лятното градинство", care: ["Поливане: Редовно и обилно", "Светлина: Пълно слънце", "Подхранване: Редовно всеки 2 седмици", "Опора: Използвайте кълчета или решетки", "Подрязване: Отстранете долните листа"] },
      { id: 20, name: "Краставица (Cucumis sativus)", description: "Зеленчук, нуждаещ се от топлина и влага", care: ["Поливане: Обилно и редовно", "Светлина: Пълно слънце", "Подхранване: Всеки 2 седмици", "Опора: Решетки или кълчета", "Почва: Плодородна, добре дренирана"] },
      { id: 21, name: "Пипер (Capsicum annuum)", description: "Термофилна овощ с богат вкус", care: ["Поливане: Редовно и умерено", "Светлина: Пълно слънце", "Подхранване: Всеки 2 седмици", "Температура: Предпочита топлина (20-30°C)", "Почва: Плодородна, добре дренирана"] },
      { id: 22, name: "Лук (Allium cepa)", description: "Незаменим в кухнята и лесен за отглеждане", care: ["Поливане: Умерено", "Светлина: Пълно слънце", "Подхранване: Минимално", "Разстояние: 10-15 см между растенията", "Събиране: Когато листата потъмнеят"] },
      { id: 23, name: "Чесън (Allium sativum)", description: "Вкусна овощ с здравословни свойства", care: ["Поливане: Умерено в основата", "Светлина: Пълно слънце", "Подхранване: При засаждане и пролет", "Засаждане: През октомври-ноември", "Събиране: През юни-юли"] },
      { id: 24, name: "Моркови (Daucus carota)", description: "Сладко-оранжев коренен зеленчук", care: ["Поливане: Редовно и умерено", "Светлина: Пълно слънце", "Подхранване: Лек тор при растеж", "Разстояние: 5-10 см между растенията", "Събиране: След 60-80 дни"] },
    ]
  };

  const generalCare = [
    { title: "Поливане", tips: ["Поливайте рано сутрин или късно вечер, за да избегнете изпаряване", "През лятото поливайте по-често, предпочитайте ранни часове", "Използвайте капково напояване за икономичност и ефективност", "Избягвайте преливане и заблатяване на почвата"] },
    { title: "Торене и подхранване", tips: ["Подхранвайте растенията през вегетационния период", "Използвайте комплексни торове според вида растение", "Органичните торове са полезни за дълготрайна економичност", "Редовно подрязване насърчава гъстия растеж"] },
    ...
    { title: "Почва и мулчиране", tips: ["Добре дренирана почва е критична", "Мулчирайте с органични материали", "Поддържайте правилен pH на почвата"] },
    { title: "Защита от болести и вредители", tips: ["Редовно проверявайте растенията", "Премахвайте засегнатите листа", "Използвайте органични препарати", "Поддържайте добра циркулация на въздуха"] },
  ];

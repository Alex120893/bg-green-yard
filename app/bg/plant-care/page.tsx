...
export default function PlantAndLawnCare() {
  ...
  const plants = {
    ...
    vegetables: [
      ...
      { id: 23, name: "Чесън (Allium sativum)", description: "Вкусна овощ с здравословни свойства", care: ["Поливане: Умерено в основатa", "Светлина: Пълно слънце", "Почва: Богата, добре дренирана", "Засаждане: През есента", "Събиране: През лято"] },
  ...
  const lawnCareGuides = [
    ...
    { title: "Сезонна грижа", icon: "🌍", tips: ["Пролет: аерирайте, торете, почнете редовно косене", "Лято: интензивен полив, всяседневно косене", "Есен: подготовка към зимата, последно торене", "Зима: минимална грижа, съхранение на инструменти"] }
  ];

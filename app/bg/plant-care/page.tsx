...
export default function PlantAndLawnCare() {
  ...
  const lawnCareGuides = [
    ...
    { title: "Борба със сорняци", icon: "🚫", tips: ["Редовно кошене превысува сорняци", "Здравата трава сама се защитава от сорняци", "Ръчна прополка за малки участъци", "Селективни гербициди при необходимост"] },
    { title: "Аерация и дренаж", icon: "🌬️", tips: ["Аерирайте газона 1-2 пъти годишно", "Пролет и есен са идеални периоди", "Използвайте специален аератор или вилане", "Подобрява дренажа и растежа"] },
    ...
    { title: "Сезонна грижа", icon: "🌍", tips: ["Пролет: аерирайте, торете, почнете редовно косене", "Лято: интензивен полив, всяседневно косене", "Есен: подготовка към зимата, последно торение", "Зима: минимална грижа, съхранение на инструменти"] }
  ];

          ...
          <Reveal>
            ...
            <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              ...
              <Link
                ...
                className="inline-flex h-13 items-center justify-center rounded-full border-2 border-white/40 px-9 text-base font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:border-white/70"
              >
                {t.home.ctaPrimary}
              </Link>
            </div>
